...
import com.spring.test.domain.posts.PostsRepository;
...
public class PostsApiControllerTest {
    ...
    @Autowired
    private TestRestTemplate restTemplate;  /* 내부 JPA 기능 테스트 */
    ...
    @Test
    public void Posts_update () throws Exception {  /* 게시글 수정 API Test*/
